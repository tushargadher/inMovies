...
export default function ContentModel({ children, type, id }) {
  //getting props value
            ...
            {res && (
              <div className="contentModel">
                ...
                <div className="contentInfo">
                  ...
                  {/**for displaying only year from the date */}
                  {res.tagline && (
                  ...
                  >
                    <span className="ytbtn"> Watch Trailer </span>
                  </Button>
                </div>
              </div>
            )}
